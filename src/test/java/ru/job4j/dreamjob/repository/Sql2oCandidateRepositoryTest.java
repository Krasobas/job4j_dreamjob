...
class Sql2oCandidateRepositoryTest {
    ...
    void whenSaveThenGetSame() {
        ...
        var candidate = sql2oCandidateRepository.save(new Candidate(0, "Ivan Ivanov", "Java Developer", 2, file.getId(), creationDate));
    ...
    void whenSaveSeveralThenGetAll() {
        var creationDate = now().truncatedTo(ChronoUnit.MINUTES);
        var candidate1 = sql2oCandidateRepository.save(new Candidate(0, "Ivan Ivanov", "Java Developer", 2, file.getId(), creationDate));
        var candidate2 = sql2oCandidateRepository.save(new Candidate(0, "Petr Ivanov", "Java Developer", 1, file.getId(), creationDate));
        var candidate3 = sql2oCandidateRepository.save(new Candidate(0, "Ivan Petrov", "Java Developer", 3, file.getId(), creationDate));
    ...
    public void whenDeleteThenGetEmptyOptional() {
        var creationDate = now().truncatedTo(ChronoUnit.MINUTES);
        var candidate = sql2oCandidateRepository.save(new Candidate(0, "title", "description", 1, file.getId(), creationDate));
    ...
    public void whenUpdateThenGetUpdated() {
        ...
        var updatedCandidate = new Candidate(
                ...
                1, file.getId(), creationDate.plusDays(1)
        );
    ...
    public void whenUpdateUnExistingCandidateThenGetFalse() {
        var creationDate = now().truncatedTo(ChronoUnit.MINUTES);
        var candidate = new Candidate(0, "title", "description", 1, file.getId(), creationDate);
