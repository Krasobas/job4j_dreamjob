...
public class Sql2oVacancyRepositoryTest {
    ...
    public void whenSaveThenGetSame() {
        ...
        var vacancy = sql2oVacancyRepository.save(new Vacancy(0, "title", "description", true, 1, file.getId(), creationDate));
    ...
    public void whenSaveSeveralThenGetAll() {
        var creationDate = now().truncatedTo(ChronoUnit.MINUTES);
        var vacancy1 = sql2oVacancyRepository.save(new Vacancy(0, "title1", "description1", true, 1, file.getId(), creationDate));
        var vacancy2 = sql2oVacancyRepository.save(new Vacancy(0, "title2", "description2", false, 1, file.getId(), creationDate));
        var vacancy3 = sql2oVacancyRepository.save(new Vacancy(0, "title3", "description3", true, 1, file.getId(), creationDate));
    ...
    public void whenUpdateThenGetUpdated() {
        ...
        var updatedVacancy = new Vacancy(
                ...
                !vacancy.getVisible(), 1, file.getId(), creationDate.plusDays(1)
        );
    ...
    public void whenUpdateUnExistingVacancyThenGetFalse() {
        var creationDate = now().truncatedTo(ChronoUnit.MINUTES);
        var vacancy = new Vacancy(0, "title", "description", true, 1, file.getId(), creationDate);
