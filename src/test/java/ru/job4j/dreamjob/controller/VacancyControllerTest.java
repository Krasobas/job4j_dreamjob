...
public class VacancyControllerTest {
    ...
    public void whenRequestVacancyListPageThenGetPageWithVacancies() {
        var vacancy1 = new Vacancy(1, "test1", "desc1", true, 1, 2, now());
        var vacancy2 = new Vacancy(2, "test2", "desc2", false, 3, 4, now());
    ...
    public void whenPostVacancyWithFileThenSameDataAndRedirectToVacanciesPage() throws Exception {
        var vacancy = new Vacancy(1, "test1", "desc1", true, 1, 2, now());
    ...
    public void whenRequestVacancyByIdThenGetVacancyPageWithCities() {
        var expectedVacancy = new Vacancy(1, "test1", "desc1", true, 1, 2, now());
        when(vacancyService.findById(anyInt())).thenReturn(Optional.of(expectedVacancy));
        var city1 = new City(1, "Москва");
        var city2 = new City(2, "Санкт-Петербург");
        var expectedCities = List.of(city1, city2);
        when(cityService.findAll()).thenReturn(expectedCities);
    ...
    @Test
    public void whenRequestVacancyByIdThenOptionalEmpty() {
        ...
        assertThat(view).isEqualTo("errors/404");
        assertThat("Вакансия с указанным идентификатором не найдена").isEqualTo(model.getAttribute("message"));
        verify(vacancyService).findById(anyInt());
    ...
    @Test
    public void whenUpdateVacancyAndSomeExeptionThenGetErrorPageWithMessage() {
        var expectedException = new RuntimeException("Failed to write file");
    ...
    @Test
    public void whenUpdateVacancyReturnFalseExeptionThenGetErrorPageWithMessage() {
    ...
    @Test
    public void whenRequestDeleteVacancyReturnFalseThenGetErrorPageWithMessage() {
